...
typedef ncclResult_t (*ncclGroupStartFn)();
typedef ncclResult_t (*ncclGroupEndFn)();
...
static ncclGroupStartFn orig_ncclGroupStart = NULL;
static ncclGroupEndFn orig_ncclGroupEnd = NULL;
