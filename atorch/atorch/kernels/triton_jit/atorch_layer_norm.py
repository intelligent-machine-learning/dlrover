...
def atorch_layer_norm(
    input: torch.Tensor, normalized_shape: Union[int, List[torch.Size]], weight: torch.Tensor, bias: bool, eps: float
):
    """
    layer norm fused by triton jit
    ...
    Returns:
        torch.Tensor
    """
    return AtorchLayerNormFunc.apply(input, normalized_shape, weight, bias, eps)
