...
from llama_recipes.utils.memory_utils import MemoryTrace, report_device_memory
...
def train(model, train_dataloader,eval_dataloader, tokenizer, optimizer, lr_scheduler, gradient_accumulation_steps, train_config, fsdp_config=None, local_rank=None, rank=None):
    ...
    if train_config.show_throughput:
        print("Use deepspeed ThroughputTimer")
        from deepspeed.utils.timer import ThroughputTimer
        total_batch_size = torch.distributed.get_world_size() * train_config.batch_size_training
    ...
    for epoch in range(train_config.num_epochs):
        ...
        with MemoryTrace() as memtrace:  # track the memory usage
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                if train_config.show_throughput:
                    tput_timer.stop(global_step=True, report_speed=(torch.distributed.get_rank() == 0))
