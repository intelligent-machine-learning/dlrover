from atorch.ops.op_builder.builder import installed_cuda_version
from atorch.ops.op_builder.all_ops import ALL_OPS
from atorch.ops.op_builder import get_default_compute_capabilities, OpBuilder
...
if torch_available:
    ...
    cmdclass['build_ext'] = get_accelerator(
    ).build_extension().with_options(use_ninja=False)
...
setup(
    ...
    data_files=["atorch/requirements.txt",
                "bin/build_proto.sh", "atorch/protos/coworker.proto"],
)
