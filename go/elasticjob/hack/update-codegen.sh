...
export INPUT_PACKAGE="elastic.iml.github.io/v1alpha1:github.com/intelligent-machine-learning/dlrover/go/elasticjob/api/v1alpha1"
export OUTPUT_PKG="${MODULE}/client"
