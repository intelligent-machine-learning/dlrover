...
write_to_bazelrc "build --linkopt=\"-ldl\""
...
write_action_env_to_bazelrc "LD_LIBRARY_PATH" "/usr/local/lib/python3.8/dist-packages/tensorflow/:/usr/local/nvidia/lib:/usr/local/nvidia/lib64"
