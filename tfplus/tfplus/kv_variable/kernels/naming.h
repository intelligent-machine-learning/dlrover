...
#ifndef TFPLUS_KV_VARIABLE_KERNELS_NAMING_H_
#define TFPLUS_KV_VARIABLE_KERNELS_NAMING_H_
...
string DataFilename(StringPiece prefix, int32 shard_id, int32 num_shards);  // NOLINT

}  // namespace tfplus

#endif  // TFPLUS_KV_VARIABLE_KERNELS_NAMING_H_
