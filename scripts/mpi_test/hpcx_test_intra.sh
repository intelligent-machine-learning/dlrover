...
export SLURM_OUTPUT="/home/xiangd/WORK/zbw/ompi_build/openmpi-4.1.5/output/output20240114_intra/$SLURM_JOB_ID-hpcx-Algo$method-Mid$m_group_num-MidAlgo$MID_ALGO-Inplace$INPLACE.log"

/home/xiangd/WORK/zbw/hpcx/ompi/bin/mpirun -x UCX_TLS=dc,shm,self  -x HCOLL_ENABLE_SHARP=3 -x SHARP_COLL_ENABLE_SAT=1 \
-np $np ./IMB-MPI1 -npmin $np Allreduce $@ > $SLURM_OUTPUT
hpcx_unload
