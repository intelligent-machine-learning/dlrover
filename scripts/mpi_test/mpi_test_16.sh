...
return=${RETURN:-10}
np=16
MID_ALGO1=${MID_ALGO1:--1}
MID_ALGO2=${MID_ALGO2:--1}
INPLACE=${INPLACE:-0}

mkdir /home/xiangd/WORK/zbw/ompi_build2/ompi-4.1.5/output/output20240530_$np
export SLURM_OUTPUT="/home/xiangd/WORK/zbw/ompi_build2/ompi-4.1.5/output/output20240530_$np/$SLURM_JOB_ID-Algo$method-Mid$m_group_num-MidAlgo$MID_ALGO1,$MID_ALGO2-Inplace$INPLACE.log"
