...
if __name__ == '__main__':
    ...
    for _ in range(1000):
        ...
        if step % 50 == 0:
            ...
            checkpointer.save_checkpoint(step, state_dict, storage_type=StorageType.MEMORY)
        ...
        if step % 200 == 0:
            ...
            checkpointer.save_checkpoint(step, state_dict, storage_type=StorageType.DISK)
