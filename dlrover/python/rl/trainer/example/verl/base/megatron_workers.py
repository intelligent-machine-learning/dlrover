...
from dlrover.python.rl.trainer.example.verl.base.decorator import register, \
    Dispatch, dispatch_one_to_all, dispatch_megatron_compute_data_proto, \
    collect_megatron_compute_data_proto, dispatch_megatron_pp_as_dp_data_proto, \
    collect_megatron_pp_as_dp_data_proto
from dlrover.python.rl.trainer.example.verl.base.worker import MegatronWorker
from dlrover.python.rl.trainer.workload import trainer_invocation
...
class ActorRolloutRefWorker(MegatronWorker):
    ...
    @trainer_invocation(pre_func=dispatch_megatron_compute_data_proto, post_func=collect_megatron_compute_data_proto)
    ...
    @trainer_invocation(pre_func=dispatch_megatron_pp_as_dp_data_proto,
