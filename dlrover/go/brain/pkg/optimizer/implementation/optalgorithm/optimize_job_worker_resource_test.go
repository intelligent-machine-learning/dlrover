...
//	dataStore := &impldatastore.ElasticDataStore{
//		CougarDBRecorder: cougardb.NewFakeRecorder(),
//	}
//
//	jobUUID := "job-uuid-1"
//	cluster := "cluster"
...
//		},
//		Metrics: &common.JobMetrics{
//			MetricJobRuntime:             string(rtInfosStr),
//			MetricTrainingDatasetFeature: string(setFeatureStr),
//			TrainingHyperParams:          string(hyperParamStr),
//		},
//	}
//
//	conf := &optimizerconfig.OptimizeAlgorithmConfig{
//		CustomizedConfig: map[string]string{
//			config.OptimizerWorkerMaxReplicaCount:      "10",
//			config.OptimizerStepCountThreshold:         strconv.Itoa(stepCount),
//			config.OptimizerPSCPUExhaustedThreshold:    "0.95",
...
//	task := &cougardb.Task{
//		Name:          "task-ps-0",
//		JobUUID:       utils.GetJobUUIDForDBRecord(jobUUID),
//		TaskGroupName: common.PSTaskGroupName,
//		Cluster:       cluster,
//		CPU:           float32(totalPSCPU),
//	}
//	dataStore.CougarDBRecorder.TasksRecorder.Upsert(task)
//
//	///////////////////////////////////////
//	plan, err := OptimizeJobWorkerResource(dataStore, conf, optJob, nil)
//	assert.NoError(t, err)
