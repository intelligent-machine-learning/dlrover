...
class BaseExecutorTest(unittest.TestCase):
    def test_get_cluster_info_by_tf_config(self):
        ...
        cluster_spec = {'ps': ['web04-pod2.default.svc:5002'], \
                        'chief': ['p1.default.svc:5001'], \
                        'worker': ['web04-pod1.default.svc:5000']}
    ...
    def test_get_cluster_def(self):
        ...
        mini_cluster_spec =  {'ps': ['web04-pod2.default.svc:5002'], \
                              'worker': ['web04-pod1.default.svc:5000']}
        self.assertDictEqual(mini_cluster_spec, base_executor.mini_cluster_spec)
        ...
        self.assertEqual(cluster_def.job[1].tasks[1],'web04-pod1.default.svc:5000')
    ...
    def test_get_chief_config(self):
        ...
        self.assertEqual(estimator_run_config._master, "grpc://p1.default.svc:5001")
 
        self.assertEqual(sess_config.experimental.\
    ...
    def test_get_worker_config(self):
        ...
        estimator_run_config = base_executor.get_config(cluster_spec)
        sess_config = estimator_run_config._session_config
        self.assertEqual(estimator_run_config._master, "grpc://web04-pod1.default.svc:5000")
        self.assertEqual(sess_config.experimental.\
                         share_session_state_in_clusterspec_propagation, True)
