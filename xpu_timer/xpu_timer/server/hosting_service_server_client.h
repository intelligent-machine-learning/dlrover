...
private:
  ...
  template <typename MetricsType> static void setUpInner() {
...
public:
  ...
  template <typename T> static void *RunServerJob(void *args) {
...
public:
  ...
  void
  requestRegisterPrometheus(bool sync, const std::string &name,
                            const std::string &gauge_name, int rank,
                            int local_rank,
...
private:
  ...
  static void HandleDumpResponse(brpc::Controller *cntl,
                                 StacktraceResponse *response);
  static void
  HandleRegisterPrometheusResponse(brpc::Controller *cntl,
                                   RegisterPrometheusResponse *response);
  static void HandlePushPrometheusResponse(brpc::Controller *cntl,
                                           google::protobuf::Empty *response);
  static void
  HandleDeregisterPrometheusResponse(brpc::Controller *cntl,
                                     RegisterPrometheusResponse *response);
